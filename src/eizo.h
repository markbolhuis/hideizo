...
#define USB_PRODUCT_ID_EIZO_EV2360 0x405a
...
#define USB_PRODUCT_ID_EIZO_EV2480 0x406a
#define USB_PRODUCT_ID_EIZO_EV2495 0x405e
#define USB_PRODUCT_ID_EIZO_EV2750 0x4014
#define USB_PRODUCT_ID_EIZO_EV2760 0x4059
#define USB_PRODUCT_ID_EIZO_EV2780 0x402b
...
#define USB_PRODUCT_ID_EIZO_EV3895 0x4065
...
#define EIZO_USAGE_MODEL_SPACE        0x00c3ff00
#define EIZO_USAGE_EMERGENCY_POWER    0x00c5ff00
#define EIZO_USAGE_INPUT_MODE         0x00c9ff00
#define EIZO_USAGE_HORIZONTAL_RES     0x00caff00
#define EIZO_USAGE_VERTICAL_RES       0x00cbff00
#define EIZO_USAGE_FIRMWARE_VERSION   0x00d8ff00

#define EIZO_USAGE_BRIGHT_REG_OP      0x0007ff01
#define EIZO_USAGE_ECOVIEW_SENSOR     0x000cff01
#define EIZO_USAGE_BUTTON             0x003dff01
#define EIZO_USAGE_DISPLAY_MODE       0x0040ff01
...
#define EIZO_USAGE_AUTO_INPUT         0x0053ff01
#define EIZO_USAGE_POWER_SAVE         0x0054ff01
#define EIZO_USAGE_CUSTOM_KEY_LOCK    0x005aff01
#define EIZO_USAGE_SUPER_RES          0x005bff01
#define EIZO_USAGE_ECOVIEW_SETTINGS_2 0x0078ff01
#define EIZO_USAGE_SAVE               0x00a0ff01
#define EIZO_USAGE_FACTORY_RESET      0x00a1ff01
#define EIZO_USAGE_ECOVIEW_OPT_2      0x00ebff01
#define EIZO_USAGE_ACTIVE_WINDOW      0x00f9ff01
#define EIZO_USAGE_PIC_BY_PIC_LAYOUT  0x00faff01
#define EIZO_USAGE_WINDOW_HIGHLIGHT   0x00fcff01
#define EIZO_USAGE_COMPATABILITY      0x00feff01
...
#define EIZO_USAGE_FRONT_LUT_ENABLED  0x000dff02
#define EIZO_USAGE_SERIAL_NULL        0x0036ff02
#define EIZO_USAGE_EDIDDDC_WRITE      0x0037ff02
#define EIZO_USAGE_AGING_MODE         0x0044ff02
#define EIZO_USAGE_FACTORY_PANEL_LUM  0x0055ff02
#define EIZO_USAGE_GAIN_DEFINITION    0x00ddff02
#define EIZO_USAGE_MODEL_NULL         0x0100ff02
...
#define EIZO_VALUE_INPUT_MODE_ANALOGUE 0
#define EIZO_VALUE_INPUT_MODE_DIGITAL 1
#define EIZO_VALUE_INPUT_MODE_UNKNOWN 2
...
#define EIZO_VALUE_INPUT_USBC  EIZO_VALUE_INPUT_DP2
...
#define EIZO_VALUE_SCREEN_3 2
#define EIZO_VALUE_SCREEN_4 3
...
#define EIZO_VALUE_DISPLAY_MODE_SINGLE 0
#define EIZO_VALUE_DISPLAY_MODE_PIC_BY_PIC 1
#define EIZO_VALUE_DISPLAY_MODE_PIC_IN_PIC 2
